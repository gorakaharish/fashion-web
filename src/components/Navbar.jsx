...
const Navbar = ({ setShowCart }) => {
  ...
  return (
    <header className="fixed w-full z-10">
      <section>
        <div className="flex flex-row justify-between p-5 md:px-32 px-5 bg-PrimaryColor shadow-[rgba(0,_0,_0,_0.24)_0px_5px_8px]">
          <div>
          ...
          <nav className="hidden lg:flex flex-row items-center text-lg font-semibold gap-8 text-ExtraDarkColor">
            <Link
              ...
              spy={true}
              duration={500}
              className="cursor-pointer hover:text-black duration-300 ease-in-out"
            >
              Home
            </Link>
            <Link
