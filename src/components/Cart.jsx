...
const Cart = ({ setShowCart }) => {
  ...
  return (
    <div className="bg-[#00000007d] w-full min-h-screen fixed left-0 top-0 z-20  overflow-y-scroll">
      <div className=" max-w-[400px] w-full min-h-full bg-white absolute right-0 top-0 p-6">
        ...
        <button className=" bg-ExtraDarkColor text-white w-full fy-2 font-medium">Product to Buy</button>
        <button className="border-2 border-DarkColor text-dark w-full my-2 py-2">Go to Cart</button>
      </div>
    </div>
  );
};
